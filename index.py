...
def app():
    ...
    <style>
        .section-header {
            font-size: 23px;
            font-weight: bold;
            color:#006400; /* Warna hijau toska */
            margin-top: 20px;
            text-align: left;
        }
  ...
  # Menampilkan judul dengan font kecil dan warna menggunakan st.markdown()
    st.markdown("<h1 style='font-size: 30px; color: #006400; text-align: center'>SMK HUTAMA BEKASI</h1>", unsafe_allow_html=True)
    ...
    if menu == "Beranda":
        ...
        col1, col2, col3 = st.columns(3)
        with col1:
            st.image("https://smkhutama.sch.id/wp-content/uploads/2020/12/slider4.jpg", use_container_width=True)
        with col2:
            st.image("https://smkhutama.sch.id/wp-content/uploads/2020/12/slider11.jpg", use_container_width=True)
        with col3:
            st.image("https://smkhutama.sch.id/wp-content/uploads/2020/12/slider12.jpg", use_container_width=True)
    ...
    # Misi
        st.markdown("<div class='section-header' style='font-size:20px;'>MISI</div>", unsafe_allow_html=True)
        st.markdown("""
<ul class='text-description' style='font-size:8px;'>
...
""", unsafe_allow_html=True)
     # Hubungi Kami
        ...
        col1, col2, col3 = st.columns(3)
        with col1:
            st.image("https://smkhutama.sch.id/wp-content/uploads/2024/11/IMG-20241107-WA0007.jpg", use_container_width=True)
        with col2:
            st.image("https://smkhutama.sch.id/wp-content/uploads/2024/11/IMG-20241010-WA0256-scaled.jpg", use_container_width=True)
        with col3:
            st.image("https://smkhutama.sch.id/wp-content/uploads/2024/11/IMG-20241011-WA0008-scaled.jpg", use_container_width=True)
